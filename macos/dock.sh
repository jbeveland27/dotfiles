...
dockutil --no-restart --add "~/Dropbox/Apps/VerticalBar.app"
dockutil --no-restart --add "/Applications/Calendar.app"
dockutil --no-restart --add "/Applications/Notes.app"

dockutil --no-restart --add "~/Dropbox/Apps/VerticalBar 2.app"
dockutil --no-restart --add "/Applications/Messages.app"
dockutil --no-restart --add "/Applications/iTunes.app"
dockutil --no-restart --add "/Applications/Spotify.app"
dockutil --no-restart --add "/Applications/System Preferences.app"

dockutil --no-restart --add "~/Dropbox/Apps/VerticalBar 3.app"
...
dockutil --no-restart --add "~/Dropbox/Apps/VerticalBar 4.app"
